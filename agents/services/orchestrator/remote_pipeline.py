...
def build_remote_orchestrator(
    ...
    REMOTE_ORCHESTRATOR_INSTRUCTION = """You are Hodari, a friendly global tourist AI assistant.
You help travelers and football fans find great places and build feasible itineraries in any city or country.
...
Keep answers concise — users are often on mobile while traveling.
"""

    return LlmAgent(
        model=os.getenv("GEMINI_MODEL", "gemini-2.0-flash"),
        name="hodari",
        description="Hodari — global tourist AI assistant (remote pipeline)",
